...
void test_ctad()
{
    ...
    {
        auto fr = function_ref(fn<f>);
        static_assert(std::is_same_v<decltype(fr), function_ref<int()>>);
    }

    {
        auto fr = function_ref(fn<f_good>);
        static_assert(
            std::is_same_v<decltype(fr), function_ref<int() noexcept>>);
    }

    {
        auto fr = function_ref(fn<h>);
        static_assert(std::is_same_v<decltype(fr), function_ref<int(A)>>);
    }

    {
        auto fr = function_ref(fn<h_good>);
        static_assert(
            std::is_same_v<decltype(fr), function_ref<int(A) noexcept>>);
    }
    ...
    {
        A a;
        auto fr = function_ref(fn<&A::g>, &a);
        static_assert(std::is_same_v<decltype(fr), function_ref<int()>>);
    }

    {
        A a;
        auto fr = function_ref(fn<&A::k>, &a);
        static_assert(std::is_same_v<decltype(fr), function_ref<int()>>,
    ...
    {
        A a;
        auto fr = function_ref(fn<&A::data>, &a);
        static_assert(std::is_same_v<decltype(fr), function_ref<int &()>>);

        auto fc = function_ref(fn<&A::data>, std::as_const(a));
    ...
    {
        A a;
        auto fr = function_ref(fn<&h>, a);
        static_assert(std::is_same_v<decltype(fr), function_ref<int()>>);
    }

    {
        A a;
        auto fr = function_ref(fn<&h_good>, a);
        static_assert(
            std::is_same_v<decltype(fr), function_ref<int() noexcept>>);
    }
}